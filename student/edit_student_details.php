                        ...
                        <div class="module-body">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if (!empty($_FILES["profile_picture"]["name"])) {
                                    require('scripts/upload_handler.php');
                                }
                            ...
                            <form class="form-horizontal row-fluid" action="edit_student_details.php?id=<?php echo $rollno ?>" method="post">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="profile_picture"><b>Profile Picture:</b></label>
                                    <div class="controls">
                                        <input type="file" id="profile_picture" name="profile_picture" accept="image/*" class="span8">
